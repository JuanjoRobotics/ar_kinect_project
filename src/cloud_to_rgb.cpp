...
namespace tabletop_segmentation {
	...
	public:
		...
		{
			//std::string image_topic = nh_.resolveName("/kinect/rgb_image");
			std::string image_topic = "/kinect/rgb_image";
		...
		void imageCb(const sensor_msgs::ImageConstPtr& msg){
			...
			std::string pcl_topic = "/cloud_out";
			...
			//ROS_INFO_STREAM("pcl received after " << Now – start_time << " seconds. Start Combining…");
...
int main(int argc, char **argv){
	ros::init(argc, argv, "cloutd_to_rgb");
	ros::NodeHandle nh;
